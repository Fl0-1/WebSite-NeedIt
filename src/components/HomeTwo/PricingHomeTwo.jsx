...
function PricingHomeTwo() {
    ...
    return (
        <>
            <section className="needit-pricing-2-area pb-100">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">Simple pricing for Everyone</h3>
                                <p>
                                    The full monty spiffing good time no biggie cack grub fantastic.
                                </p>
                                <div className="needit-pricing-tab-btn">
                                    <ul
                                    ...
                                    >
                                        ...
                                        >
                                            <a
                                                onClick={(e) => handleSwitch(e)}
                                                className={`nav-link  ${toggleSwitch === false ? 'active' : ''
                                                    }`}
                                                href="#"
                                                type="button"
                                                role="tab"
