...
function CounterArea({ style }) {
    return (
        <>
            <section className="needit-counter-area pt-90 pb-190" id="counter" style={style}>
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="needit-single-counter mt-30 wow animated fadeInUp"
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="needit-single-counter mt-30 item-2 wow animated fadeInUp"
                                data-wow-duration="2000ms"
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="needit-single-counter mt-30 item-3 wow animated fadeInUp"
                                data-wow-duration="2000ms"
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="needit-single-counter mt-30 item-4 wow animated fadeInUp"
                                data-wow-duration="2000ms"
