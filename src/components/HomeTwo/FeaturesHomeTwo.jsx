...
function FeaturesHomeTwo() {
    return (
        <>
            <section className="needit-features-area-2 pt-90 pb-100" id="features">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-12">
                            <div className="needit-section-title needit-section-title-2 text-center">
