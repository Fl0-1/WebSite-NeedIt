...
function AboutHomeTwo() {
    return (
        <>
            <section className="needit-about-area mb-100">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div
                                className="needit-about-box wow animated fadeInUp"
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="needit-about-content">
                                            <span>Marketing</span>
                                            <h3 className="title">
                                                Make a lasting impression with needit.
                                            </h3>
                                            <p>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="needit-about-service mt-30">
                                                    <div className="icon">
