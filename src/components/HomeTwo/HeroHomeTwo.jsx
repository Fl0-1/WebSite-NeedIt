...
function HeroHomeTwo() {
    return (
        <>
            <section className="needit-hero-area-2 mb-90">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5">
                            <div className="needit-hero-content-2">
                                <span>14 day free</span>
                                <h1 className="needit-title">
                                    Ready to launch your app in one, <span>Application</span>
                                </h1>
                                <p>Find the best application in the needit.</p>
                                <form action="#">
                                    <div className="input-box">
                                        <input type="text" placeholder="info@needit.com" />
                ...
                <div
                    className="needit-hero-thumb-3 wow animated fadeInRight"
