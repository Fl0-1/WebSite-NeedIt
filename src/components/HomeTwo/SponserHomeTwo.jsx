...
function SponserHomeTwo({ className }) {
    return (
        <>
            <section className={`needit-sponser-area pb-100 ${className}`}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">
                                    NeedIt works best with <br />
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-sponser-box d-flex justify-content-center">
                            ...
                            <div className="needit-sponser-box item-2 d-flex justify-content-center">
                                <div className="sponser-item">
