...
function TestimonialHomeTwo() {
    ...
    return (
        <>
            <section className="needit-testimonial-2-area mb-90" id="testimonial">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-testimonial-2-box">
                                <div
                                    className="needit-testimonial-slider-2"
                                ...
                                >
                                    ...
                                    <Slider ref={sliderRef} {...settings}>
                                        <div className="needit-testimonial-slider-2-item">
                                            <div className="item">
                                                <div className="thumb">
