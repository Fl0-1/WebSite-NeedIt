...
function HeroHomeSix() {
    return (
        <>
            <section className="needit-hero-area needit-hero-6-area">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="needit-hero-content needit-hero-content-6">
                                <span>Welcome To Creative App.</span>
                                <h1 className="needit-title">Get started with NeedIt Template.</h1>
                                <p>
