...
function HeroHomeSeven() {
    return (
        <>
            <section className="needit-hero-area needit-hero-6-area needit-hero-7-area">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-7">
                            <div className="needit-hero-content needit-hero-content-6 needit-hero-content-7">
                                <h1 className="needit-title">Creative way to Showcase your app </h1>
                                <p>
                        ...
                        <div className="col-lg-5">
                            <div className="needit-hero-thumb-6">
                                <div
