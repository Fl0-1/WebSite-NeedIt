...
function FeaturesHomeFour() {
    return (
        <>
            <section
                className="needit-features-area-2 needit-features-area-5 pt-90 pb-100"
                id="features"
            >
                <div className="container">
                    ...
                    <div className="row mt-30 align-items-center">
                        <div className="col-lg-6">
                            <div className="needit-features-boxes ">
                                <div className="needit-features-box-item needit-features-box-5-item">
                                    <h4 className="title">Well Integrated</h4>
                                    <p>The bee's knees chancer car boot absolutely.</p>
                                </div>
                                <div className="needit-features-box-item item-2 needit-features-box-5-item">
                                    <h4 className="title">Clean and modern Design</h4>
                                    <p>The bee's knees chancer car boot absolutely.</p>
                                </div>
                                <div className="needit-features-box-item item-3 needit-features-box-5-item">
                        ...
                        <div className="col-lg-6">
                            <div
                                className="needit-features-thumb wow animated fadeInRight"
