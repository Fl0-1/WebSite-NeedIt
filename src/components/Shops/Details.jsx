                            ...
                            <div className="shop-product-details-content pl-70 mt-35">
                                ...
                                <div className="details-info">
                                    <ul>
                                        ...
                                        <li>
                                            <span>Categories: </span> Watch, NeedIt, UX
                                        </li>
                                        <li>
                        ...
                        <div className="col-lg-8">
                            <div className="shop-details-box">
                                ...
                                <div className="tab-content" id="pills-tabContent">
                                    <div
                                        className={`tab-pane fade ${detailsTab === 'des' ? 'show active' : ''
                                            }`}
                                        id="pills-home"
                                        role="tabpanel"
                                    ...
                                    <div
                                        className={`tab-pane fade ${detailsTab === 'review' ? 'show  active' : ''
                                            }`}
                                        id="pills-profile"
                                        role="tabpanel"
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">Related products</h3>
                                <p>
