...
function DetailsService() {
    return (
        <>
            <section className="needit-service-details-area pt-100 pb-100">
                            ...
                            <div className="service-details-sidebar mr-50">
                                <div className="service-category-widget">
                                    <ul>
                                        ...
                                        <li>
                                            <i className="fal fa-bookmark"></i>NeedIt Template
                                        </li>
                                        <li>
                                            <i className="fal fa-globe"></i>quomodosoft.com/needit
                                        </li>
                                    </ul>
                                </div>
