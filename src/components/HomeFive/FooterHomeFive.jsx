...
function FooterHomeFive() {
    return (
        <>
            <section className="needit-footer-area">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-about-widget footer-about-widget-5">
                                ...
                                <p>
                                    NeedIt WordPress is theme is the last theme you will ever have.
                                </p>
                                <a href="#">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget-info">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-envelope"></i> support@needit.com
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-phone"></i> 01 30 75 36 36
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-map-marker-alt"></i> 35 Bd du Port, 95000 Cergy
                                        </a>
                                    </li>
                                </ul>
                            </div>
              ...
              "
                            >
                                ...
                                <div className="copyright-text">
                                    <p>Copyright © 2021 NeedIt. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
