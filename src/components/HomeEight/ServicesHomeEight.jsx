...
function ServicesHomeEight() {
    return (
        <>
            <section
                className="needit-services-2-area needit-services-8-area pt-90 pb-55"
                id="service"
            >
                    ...
                    <div className="row align-items-end">
                        <div className="col-lg-6 col-md-8">
                            <div className="needit-section-title">
                                <h3 className="needit-title">Solution for every need.</h3>
                        ...
                        <div className="col-lg-7">
                            <div className="row">
                                <div className="col-lg-6 col-md-6">
                                    <div
                                        className="
                    needit-single-service-2 needit-single-service-about
                    mt-30
                    wow
                    animated
                    fadeInUp
