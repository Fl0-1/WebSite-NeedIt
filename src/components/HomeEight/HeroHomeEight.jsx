...
function HeroHomeEight() {
    return (
        <>
            <section className="needit-hero-area needit-hero-8-area">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="needit-hero-content needit-hero-content-8">
                                <h1 className="needit-title">We’re a full-range design app</h1>
                                <p>
