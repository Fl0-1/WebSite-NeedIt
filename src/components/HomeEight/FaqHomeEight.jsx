...
function FaqHomeEight() {
    ...
    return (
        <>
            ...
            <div className="needit-faq-8-area pt-100 pb-100" id="counter">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5">
                            <div className="needit-section-title">
                                <h3 className="needit-title">Get started with NeedIt Template.</h3>
                                <p>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>Does NeedIt have dynamic content?</h4>
                                            </div>
                                            <div
