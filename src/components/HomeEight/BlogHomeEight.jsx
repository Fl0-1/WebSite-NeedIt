...
function BlogHomeEight() {
    return (
        <>
            <section className="needit-blog-3-area needit-blog-8-area pt-90 pb-100">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">Latest blog posts</h3>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="needit-blog-item-3 needit-blog-item-8 mt-30">
                                <div className="thumb">
                                    <img src={blog4} alt="" />
                                </div>
                ...
                <div className="needit-blog-8-shape-1">
                    <img src={shape5} alt="" />
                </div>
                <div className="needit-blog-8-shape-2">
                    <img src={shape12} alt="" />
                </div>
            </section>
        </>
