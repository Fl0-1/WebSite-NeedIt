...
function FeaturesHomeRtl({ className }) {
    ...
    return (
        <section className={`needit-features-area pt-100 ${className || ''}`} id="features">
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-3">
                        <div className="needit-features-tabs-btn">
                            <div
                        ...
                        <div className="tab-content" id="v-pills-tabContent">
                            ...
                            >
                                <div className="row align-items-center">
                                    <div className="col-lg-6">
                                        <div
                                            className="needit-features-thumb text-center wow animated fadeInUp"
                                    ...
                                    <div className="col-lg-6">
                                        <div
                                            className="needit-features-content text-right wow animated fadeInRight"
                                            data-wow-duration="2000ms"
                            ...
                            >
                                <div className="row align-items-center">
                                    <div className="col-lg-6">
                                        <div
                                            className="needit-features-thumb text-center animated fadeInUp"
                                            data-wow-duration="2000ms"
                                            data-wow-delay="200ms"
                                        >
                                            <img src={thumb} alt="" />
                                    ...
                                    <div className="col-lg-6">
                                        <div
                                            className="needit-features-content text-right animated fadeInRight"
                                            data-wow-duration="2000ms"
                                            data-wow-delay="600ms"
                                        >
                                            <span>ردود الفعل المخصصة</span>
