...
function TeamHomeRtl({ className }) {
    return (
        <>
            <section className={`needit-team-area pt-90 pb-100 ${className || ''}`}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">قابل أعضاء فريقنا</h3>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="needit-team-item mt-30 wow animated fadeInUp"
