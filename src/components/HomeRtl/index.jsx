            ...
            {lang ? (
                <>
                    ...
                    <HeaderHomeRtl
                        ...
                        className="needit-header-area-rtl"
                    />
                    <HeroHomeRtl />
                    <ServicesHomeRtl />
                    <FeaturesHomeRtl />
                    <TrafficHomeRtl className="needit-traffic-area-rtl" />
                    <TestimonialHomeRtl />
                    <TeamHomeRtl />
                    <PricingHomeRtl />
                    <FaqHomeRtl className="needit-faq-area-rtl" />
                    <BlogHomeRtl />
                    <ProjectHomeRtl className="needit-project-area-rtl" />
                    <FooterHomeRtl />
                    <BackToTop />
                </>
            ) : (
