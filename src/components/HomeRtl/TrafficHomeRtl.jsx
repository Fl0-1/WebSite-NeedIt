...
function TrafficHomeRtl({ className }) {
    return (
        <section className={`needit-traffic-area pt-140 pb-180 ${className || ''}`}>
            <div className="container">
                <div className="row">
                    <div className="col-lg-7">
                        <div className="needit-traffic-title text-right">
                            <span>مرور</span>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6">
                                <div className="needit-traffic-service text-right mb-30">
                                    <div className="icon">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="needit-traffic-service text-right item-2 mb-30">
                                    <div className="icon">
                                        <i className="fal fa-check" />
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="needit-traffic-service text-right item-3">
                                    <div className="icon">
                                        <i className="fal fa-check" />
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="needit-traffic-service text-right item-4">
                                    <div className="icon">
                                        <i className="fal fa-check" />
                                    </div>
