...
function AboutHomeThree() {
    return (
        <>
            <section className="needit-about-3-area pt-100 pb-100" id="features">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div
                                className="needit-about-thumb-3 wow animated fadeInLeft"
                        ...
                        <div className="col-lg-6">
                            <div className="needit-traffic-title">
                                <h3 className="title">
                                    NeedIt lets you launch your app in minutes.
                                </h3>
                                <p>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="needit-traffic-service mb-30">
                                        <div className="icon">
                                            <img src={icon5} alt="" />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="needit-traffic-service item-2 mb-30">
                                        <div className="icon">
                                            <img src={icon1} alt="" />
                                        </div>
                    ...
                    <div className="row align-items-center mt-100 flex-column-reverse flex-lg-row">
                        <div className="col-lg-6">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="needit-traffic-service mb-30 item-3">
                                        <div className="icon">
                                            <img src={icon6} alt="" />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="needit-traffic-service item-2 mb-30 item-4">
                                        <div className="icon">
                                            <img src={icon7} alt="" />
                                        </div>
                        ...
                        <div className="col-lg-6">
                            <div
                                className="needit-about-thumb-3 text-right wow animated fadeInRight"
                                data-wow-duration="2000ms"
                                data-wow-delay="400ms"
                            >
