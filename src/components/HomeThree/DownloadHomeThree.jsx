...
function DownloadHomeThree({ className }) {
    return (
        <>
            <section className={`needit-download-3-area pt-100 ${className || ''}`} id="download">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="needit-section-title text-center">
                                <h3 className="needit-title">Download app today!</h3>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div
                                className="needit-download-3-box mt-30 mr-20 wow animated fadeInLeft"
                        ...
                        <div className="col-lg-6">
                            <div
                                className="needit-download-3-box mt-30 ml-20 wow animated fadeInRight"
                                data-wow-duration="2000ms"
