...
function HeroAbout() {
    return (
        <>
            <div className="needit-about-top-title-area">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-7">
                            <div className="needit-about-top-title">
            ...
            <section className="needit-about-page-area">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="needit-about-page-content">
                                <h3 className="title">
