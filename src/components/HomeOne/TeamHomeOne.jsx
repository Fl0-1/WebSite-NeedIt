                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="needit-team-item-pro mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="200ms" style={cardStyle}>
                                <div>
                                ...
                                <div className="social-links" style={{ marginTop: '20px' }}>
                                    <a href="#" style={{ color: '#007bff', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-linkedin-in" /></a>
                                    <a href="#" style={{ color: '#007bff', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-github" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Jean-Juste */}
                        <div className="col-lg-4 col-md-6">
                            <div className="needit-team-item-pro mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="400ms" style={cardStyle}>
                                <div>
                                    <div className="team-photo" style={{ marginBottom: '20px' }}>
                                        <img
                                            src={jeanJusteImg}
                                ...
                                <div className="social-links" style={{ marginTop: '20px' }}>
                                    <a href="#" style={{ color: '#28a745', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-linkedin-in" /></a>
                                    <a href="#" style={{ color: '#28a745', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-github" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Dounya */}
                        <div className="col-lg-4 col-md-6">
                            <div className="needit-team-item-pro mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="600ms" style={cardStyle}>
                                <div>
                                    <div className="team-photo" style={{ marginBottom: '20px' }}>
                                        <img
                                            src={dounyaImg}
                                ...
                                <div className="social-links" style={{ marginTop: '20px' }}>
                                    <a href="#" style={{ color: '#dc3545', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-linkedin-in" /></a>
                                    <a href="#" style={{ color: '#dc3545', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-dribbble" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row justify-content-center mt-4">
                        {/* Léo */}
                        <div className="col-lg-4 col-md-6">
                            <div className="needit-team-item-pro mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="800ms" style={cardStyle}>
                                <div>
                                    <div className="team-photo" style={{ marginBottom: '20px' }}>
                                        <img
                                            src={leoImg}
                                ...
                                <div className="social-links" style={{ marginTop: '20px' }}>
                                    <a href="#" style={{ color: '#ffc107', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-linkedin-in" /></a>
                                    <a href="#" style={{ color: '#ffc107', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-github" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Lina */}
                        <div className="col-lg-4 col-md-6">
                            <div className="needit-team-item-pro mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="1000ms" style={cardStyle}>
                                <div>
                                    <div className="team-photo" style={{ marginBottom: '20px' }}>
                                        <img
                                            src={linaImg}
                                ...
                                <div className="social-links" style={{ marginTop: '20px' }}>
                                    <a href="#" style={{ color: '#6f42c1', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-linkedin-in" /></a>
                                    <a href="#" style={{ color: '#6f42c1', margin: '0 8px', fontSize: '18px' }}><i className="fab fa-twitter" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
